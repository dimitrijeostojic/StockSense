...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260925144432_AddGoodsReceipt")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.OutboxEmailMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.OutboxMessage", b =>
                {
                    ...
                    b.Property<DateTime?>("ProccessedOnUtc")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Domain.Entities.Supplier", b =>
                {
                    ...
                    b.HasIndex("TenantPublicId", "SupplierCode")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Entities.GoodsReceipt", b =>
                {
                    b.HasOne("Domain.Entities.Order", null)
                        .WithOne()
                        .HasForeignKey("Domain.Entities.GoodsReceipt", "OrderId")
            ...
            modelBuilder.Entity("Domain.Entities.GoodsReceiptItem", b =>
                {
                    b.HasOne("Domain.Entities.GoodsReceipt", null)
                        .WithMany("Items")
                    ...
                    b.HasOne("Domain.Entities.OrderItem", "OrderItem")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.GoodsReceiptItem", "OrderItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
