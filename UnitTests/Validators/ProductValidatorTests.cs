...
public sealed class CreateProductValidatorTests
{
    ...
    public void Validate_WithAllValidFields_HasNoErrors()
    {
        var request = new CreateProductRequest(
            "Widget", "SKU-001", "A widget", 9.99m, 20m, 5,
    ...
    {
        var request = new CreateProductRequest(
            name!, "SKU-001", null, 1m, 20m, 0, UnitOfMeasurement.Piece, Guid.NewGuid(), Guid.NewGuid());
    ...
    public void Validate_WithNameExceeding100Characters_HasErrorForName()
    {
        ...
        var request = new CreateProductRequest(
            longName, "SKU-001", null, 1m, 20m, 0, UnitOfMeasurement.Piece, Guid.NewGuid(), Guid.NewGuid());
    ...
    {
        var request = new CreateProductRequest(
            "Widget", sku!, null, 1m, 20m, 0, UnitOfMeasurement.Piece, Guid.NewGuid(), Guid.NewGuid());
    ...
    {
        var request = new CreateProductRequest(
            "Widget", "SKU-001", null, price, 20m, 0, UnitOfMeasurement.Piece, Guid.NewGuid(), Guid.NewGuid());
    ...
    {
        var request = new CreateProductRequest(
            "Widget", "SKU-001", null, 1m, 20m, -1, UnitOfMeasurement.Piece, Guid.NewGuid(), Guid.NewGuid());
    ...
    {
        var request = new CreateProductRequest(
            "Widget", "SKU-001", null, 1m, 20m, 0, UnitOfMeasurement.Piece, Guid.NewGuid(), Guid.NewGuid());
    ...
    {
        var request = new CreateProductRequest(
            "Widget", "SKU-001", null, 1m, 20m, 0, UnitOfMeasurement.Piece, Guid.Empty, Guid.NewGuid());
    ...
    {
        var request = new CreateProductRequest(
            "Widget", "SKU-001", null, 1m, 20m, 0, UnitOfMeasurement.Piece, Guid.NewGuid(), Guid.Empty);
    ...
    public void Validate_WithDescriptionExceeding255Characters_HasErrorForDescription()
    {
        ...
        var request = new CreateProductRequest(
            "Widget", "SKU-001", longDesc, 1m, 20m, 0, UnitOfMeasurement.Piece, Guid.NewGuid(), Guid.NewGuid());
    ...
    [InlineData(-1)]
    [InlineData(21)]
    public void Validate_WithVatRateOutOfRange_HasErrorForVatRate(decimal vatRate)
    {
        var request = new CreateProductRequest(
            "Widget", "SKU-001", null, 1m, vatRate, 0, UnitOfMeasurement.Piece, Guid.NewGuid(), Guid.NewGuid());
    ...
    [InlineData(10)]
    [InlineData(20)]
    public void Validate_WithVatRateInRange_HasNoErrorForVatRate(decimal vatRate)
    {
        var request = new CreateProductRequest(
            "Widget", "SKU-001", null, 1m, vatRate, 0, UnitOfMeasurement.Piece, Guid.NewGuid(), Guid.NewGuid());
...
public sealed class UpdateProductValidatorTests
{
    ...
    public void Validate_WithAllValidFields_HasNoErrors()
    {
        var request = new UpdateProductRequest(
            Guid.NewGuid(), "Widget", "SKU-001", "desc", 9.99m, 20m, 5,
            UnitOfMeasurement.Piece, Guid.NewGuid(), Guid.NewGuid());
    ...
    {
        var request = new UpdateProductRequest(
            Guid.Empty, "Widget", "SKU-001", null, 1m, 20m, 0, UnitOfMeasurement.Piece, Guid.NewGuid(), Guid.NewGuid());
    ...
    {
        var request = new UpdateProductRequest(
            Guid.NewGuid(), name!, "SKU-001", null, 1m, 20m, 0, UnitOfMeasurement.Piece, Guid.NewGuid(), Guid.NewGuid());
    ...
    {
        var request = new UpdateProductRequest(
            Guid.NewGuid(), "Widget", "SKU-001", null, price, 20m, 0, UnitOfMeasurement.Piece, Guid.NewGuid(), Guid.NewGuid());
    ...
    {
        var request = new UpdateProductRequest(
            Guid.NewGuid(), "Widget", "SKU-001", null, 1m, 20m, -1, UnitOfMeasurement.Piece, Guid.NewGuid(), Guid.NewGuid());
    ...
    {
        var request = new UpdateProductRequest(
            Guid.NewGuid(), "Widget", "SKU-001", null, 1m, 20m, 0, UnitOfMeasurement.Piece, Guid.Empty, Guid.NewGuid());
    ...
    {
        var request = new UpdateProductRequest(
            Guid.NewGuid(), "Widget", "SKU-001", null, 1m, 20m, 0, UnitOfMeasurement.Piece, Guid.NewGuid(), Guid.Empty);
